...
import { PROGRAM_DATA } from "../data/MarkerData";
      ...
      >
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-gray-100">
          <div className="flex items-center gap-4">
            ...
            >
              {programData?.icon === "medical" && (
                <div className="text-2xl">🏥</div>
              )}
              {programData?.icon === "book" && (
                <div className="text-2xl">📚</div>
              )}
              {programData?.icon === "home" && (
                <div className="text-2xl">🏠</div>
              )}
            </div>
            ...
            <div className="flex items-center gap-6">
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-600">
                  {programType
                    ? `${PROGRAM_DATA[programType]?.length || 0} locations`
                    : "0 locations"}
                </span>
              </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <Button
                ...
                onClick={() => {
                  ...
                  alert(
                    `Would navigate to ${programData?.name} volunteer registration page`
                  );
                }}
              >
                Start Volunteering
